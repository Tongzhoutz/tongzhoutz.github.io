...
% title hei，e
\multicolumn{2}{l}{\small{\color{blue} \large title here}} \tabularnewline \specialrule{0.15em}{3pt}{3pt}
% Summary 
...
\\\specialrule{0.15em}{3pt}{3pt}
%% Can learn
\bf{\large What can learn?} & \bf{\large Questions and Doubts} \\ \specialrule{0.15em}{3pt}{3pt}
\end{longtable}
\end{document}
